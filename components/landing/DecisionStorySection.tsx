    ...
    <section className="relative w-full bg-paper text-ink overflow-hidden -mt-6 lg:-mt-12">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 pb-20 md:pb-28 lg:pb-36">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {/* Card 01 — Rank */}
          <div className="bg-surface border border-border rounded-xl p-4 sm:p-5 shadow-sm flex flex-col justify-between">
        ...
        <div className="flex items-center justify-center my-8 sm:my-10 w-full">
