  ...
  return (
    <>
      ...
      <div className="block lg:hidden w-full bg-midnight-surface/50 border border-warm-white/10 rounded-2xl p-5 backdrop-blur-sm shadow-xl">
        {/* Compact Top Row */}
        <div className="flex items-center justify-between border-b border-warm-white/5 pb-3 mb-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          {/* Card */}
          <div className="flex-1 bg-midnight/90 border border-route-amber/20 rounded-xl p-4 flex flex-col gap-3">
            <div>
          ...
          <div className="flex sm:flex-col justify-between sm:justify-center gap-3 py-3 bg-midnight/40 border border-warm-white/5 rounded-xl px-4 sm:min-w-[120px]">
      ...
      <div className="hidden lg:block relative w-full aspect-[1.3/1] bg-midnight-surface/50 border border-warm-white/10 rounded-2xl p-6 overflow-hidden backdrop-blur-sm shadow-xl">
        ...
        <div className="absolute top-4 left-4 flex flex-col gap-0.5 bg-midnight/90 py-2 px-3 rounded-lg border border-warm-white/5 shadow-sm">
        ...
        <div className="absolute left-[30%] top-[50%] -translate-y-1/2 z-20 w-[190px] xl:w-[215px]">
          <div className="bg-midnight/95 border border-route-amber/30 rounded-xl p-3.5 shadow-xl flex flex-col gap-2 backdrop-blur-md">
            {/* Header */}
            <div className="flex flex-col gap-0.5">
